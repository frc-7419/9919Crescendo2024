...
public class RobotContainer {
    ...
    /**
     * AUTONOMOUS COMMANDS
     *  - This catagory is for all autonomous commands generated by PathPlanner
     */
    private final Command OneNoteAuto;

    /**
     * Creates new RobotContainer and configures auton and buttons
     */
    public RobotContainer() {
        OneNoteAuto = new PathPlannerAuto("OneNoteLeft"); //TODO: Fix the names of the commands running in this auto to the correct commands we need to run(the commands don't exist in this branch)
    ...
    private void configureAutoSelector() {
        autonomousChooser.setDefaultOption("One Note Auto", OneNoteAuto);
