...
public class AmpSubsystem extends SubsystemBase {
  ...
  public AmpSubsystem() {
    this.topMotor = new TalonFX(Constants.AmpConstants.topShooterID,Constants.RobotConstants.kCanbus);
    this.bottomMotor = new TalonFX(Constants.AmpConstants.bottomShooterID, Constants.RobotConstants.kCanbus);
    topMotor.setInverted(false);   //TODO: when robot is built and motor are in place check if inversion is needed
  ...
  public void periodic() {
    ...
    SmartDashboard.putNumber("amp/Bottom Velocity", getBottomVelocity());
    SmartDashboard.putNumber("amp/Top Voltage: ", topMotor.getMotorVoltage().getValue());
    SmartDashboard.putNumber("amp/Bottom Voltage: ", bottomMotor.getMotorVoltage().getValue());
    SmartDashboard.putNumber("amp/Top Temperature ", topMotor.getDeviceTemp().getValue());
    SmartDashboard.putNumber("amp/Bottom Temperature", bottomMotor.getDeviceTemp().getValue());
  }
  private void coast() {
